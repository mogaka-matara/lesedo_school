                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"  name="exam_fee"   id="exam_fee"  class="form-control" >
                            </div>
                                <div class="mb-3">
                                    <label class="form-label">Transport Fee</label>
                                    <input type="text" name="transport_fee" class="form-control" >
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <a href="classes.html#" class="btn btn-light me-2" data-bs-dismiss="modal">Cancel</a>

...
@section('content')
        ...
        <div class="content">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                <div class="my-auto mb-2">
                    <h3 class="page-title mb-1">Uniform Component</h3>
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">All the Uniforms</li>
                        </ol>
                    </nav>
                </div>
    ...
    <!-- Add Classes -->
    <div class="modal fade" id="add_uniform">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Add Uniform Component</h4>
                    <button type="button" class="btn-close custom-btn-close" data-bs-dismiss="modal"
                            aria-label="Close">
                        <i class="ti ti-x"></i>
                    </button>
                </div>
                <form action="{{ route('uniform-component.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label">Uniform Component Name</label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary">Add Uniform Component</button>
                        </div>
                    </div>
                </form>
            </div>
